class LevelCharacterAnimator
  ...
  def reached_destination_tile?
    ...
    when Direction::DOWN
      return character_position_y <= @level_character.destination_tile.center_y_position
    when Direction::LEFT
      return @level_character.character.screen_x_position <= @level_character.destination_tile.center_x_position
  ...
  def screen_x_position
    (@level_character.x_position * (Dungeon::Level::TILE_WIDTH / 2)) + @level_character.character.screen_x_position
  end
