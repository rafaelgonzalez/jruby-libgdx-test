class LevelCharacterAnimator
  ...
  def initialize(level_character)
    ...
    @level_character.character.screen_x_position = screen_x_position
    @level_character.character.screen_y_position = screen_y_position
  end
  ...
  def reached_destination_tile?
    ...
    when Direction::UP
      return @level_character.character.screen_y_position >= screen_y_position
    when Direction::DOWN
      return @level_character.character.screen_y_position <= screen_y_position
    when Direction::LEFT
      return @level_character.character.screen_x_position <= screen_x_position
  ...
  def screen_y_position
    (@level_character.destination_tile.center_y_position + CharacterRenderer::CHARACTER_GROUND_OFFSET).round
  end
end